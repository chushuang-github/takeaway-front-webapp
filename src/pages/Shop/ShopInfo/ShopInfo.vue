  ...
  <div class="shop-info">
    <div class="info-content">
      ...
      <section class="section">
        ...
        <div class="activity" v-for="(info, index) in info.supports" :key="index">
          <div class="activity-item" :class="supportClasses[info.type]">
            <span class="content-tag">
              <span class="mini-tag">{{info.name}}</span>
            </span>
            <span class="activity-content">{{info.content}}</span>
          </div>
        </div>
      </section>
